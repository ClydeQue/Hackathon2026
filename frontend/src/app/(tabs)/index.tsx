...
const styles = StyleSheet.create({
  ...
  toolbarButtonActive: { backgroundColor: '#0F1117' },
  ...
  filterActive: { backgroundColor: '#0F1117' },
  filterText: { color: '#0F1117', textTransform: 'capitalize', fontWeight: '700' },
  filterTextActive: { color: '#F4FF61' },
  outfitButton: {
    marginHorizontal: 12,
    marginBottom: 8,
    paddingVertical: 14,
  ...
  modalOptionText: { fontSize: 15, color: '#0F1117', flex: 1, fontWeight: '600' },
  modalOptionActive: { fontWeight: '900', color: '#2A6FDB' },
  modalEmpty: {
    color: '#0F1117',
    opacity: 0.6,
    fontSize: 13,
